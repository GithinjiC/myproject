...
# SECRET_KEY = 'v+vcxl2-%qmu(mzmxaif4xalpfze)hoz(+u6cku-+!n*28eop)'
...
In order to have the STATIC_URL with a dynamic fragment, 
you have to read the timestamp from a text file—for example, 
myproject/settings/last-modified.txt—that should be updated with each commit."""
